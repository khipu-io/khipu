...
object DirectByteBufferPool {
  val KeyPool = new DirectByteBufferPool(8, 10000)
  val DataPool = new DirectByteBufferPool(8, 1000)
 ...
 */
final class DirectByteBufferPool(defaultBufferSize: Int, maxPoolEntries: Int) {
