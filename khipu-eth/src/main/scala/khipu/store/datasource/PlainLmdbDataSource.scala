...
final case class PlainLmdbDataSource(env: Env[ByteBuffer], lmdbConfig: LmdbConfig)(implicit system: ActorSystem) extends DataSource {
  private val log = Logging(system, this.getClass)

  private var table = createTable()

  private def createTable(): Dbi[ByteBuffer] = env.openDbi("shared", DbiFlags.MDB_CREATE)
